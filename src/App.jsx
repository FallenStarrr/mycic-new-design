...
function App() {
 ...
 if(!token) {
  ...
  return ( <
    ...
    <
    div className = {
      navbar ? "page active-page" : "page"
    } >
    <
    div > {
      navbar ? ( <
        CloseOutlined className = "nav__logo unactive-brand-logo "
        onClick = {
          () => setNav(false)
        }
        />
      ) : ( <
        AlignLeftOutlined className = "unactive-brand-logo"
        style = {
          {
            fontSize: "30px"
          }
 ...
 <li className = "nav__item">
  ...
  to = "/colleagues" >
    ...
    Layout >
    <
    Sider className = "section sidebar"
    style = {
      {
        height: "100vh",
