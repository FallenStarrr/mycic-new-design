  ...
  Hover me <DownOutlined />
         ...
         <section className="feed">
          ...
          <Row justify="start">
              ...
              <Col span={8}><Text>Что у вас нового?</Text></Col>
              <Col>
                <Space>
        ...
        <section className="feed">
        <Space>
           <Search  size="small"placeholder="Поиск"  enterButton  className="search-inp"/>
           
           <Button type="primary" className="btn" icon={<DownOutlined />} size={"large"} >Новости</Button>
           <Button type="primary" className="btn" icon={<DownOutlined />} size={"large"}> Сортировка</Button>
           <Button type="primary" className="btn" icon={<HeartOutlined />} size={"large"}> Понравилось</Button>
           </Space>
